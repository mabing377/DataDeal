...
namespace BindDns.MongoDBEntity
{
    public static class CoreConfiguration
    {
        ...
        public static CollectionNamespace GetCollectionNamespaceForClass(Type ClassType)
        {
            var collectionName = TruncateCollectionNameIfTooLong(__databaseNamespace.Value, ClassType.Name);
            return new CollectionNamespace(__databaseNamespace.Value, collectionName);
        }

        public static CollectionNamespace GetCollectionNamespaceForMethod()
        {
            var MethodInfo = GetMethodInfoFromCallStack();
            var collectionName = TruncateCollectionNameIfTooLong(__databaseNamespace.Value, MethodInfo.DeclaringType.Name + "-" + MethodInfo.Name);
            return new CollectionNamespace(__databaseNamespace.Value, collectionName);
        }
        ...
        private static DatabaseNamespace GetDatabaseNamespace()
        {
            ...
            return new DatabaseNamespace(ConfigurationManager.ConnectionStrings["Database_mongoDB"].ConnectionString);
        }

        public static DatabaseNamespace GetDatabaseNamespaceForClass(Type ClassType)
        {
            var databaseName = TruncateDatabaseNameIfTooLong(__databaseNamespace.Value.DatabaseName + "-" + ClassType.Name);
        ...
        private static Type GetClassTypeFromCallStack()
        {
            var methodInfo = GetMethodInfoFromCallStack();
            return methodInfo.DeclaringType;
        }

        private static MethodInfo GetMethodInfoFromCallStack()
        {
